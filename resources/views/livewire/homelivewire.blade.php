        ...
        <div class="col-lg-6 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <h4 class="small font-weight-bold">Usados<span class="float-right">{{$dispositivosUsados}}%</span>
                    </h4>
                    <div class="progress">
                        <div class="progress-bar bg-success" role="progressbar" style="width: {{$dispositivosUsados}}%"
