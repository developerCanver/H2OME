...
<body id="page-top">
    ...
    <div id="wrapper">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseadministracion" aria-expanded="true" aria-controls="collapseadministracion">
          <i class="fas fa-fw fa-cog"></i>
        ...
        <div id="collapseadministracion" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ url('administracionHogar')}}">Admin Hogar</a>
            <a class="collapse-item" href="{{ url('administracion')}}">Admin Sesores</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <!-- alertas para administracion de hogar -->
                @yield('alertas')
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="{{ asset('img/undraw_posting_photo.svg')}}"
                        alt="">
                    </div>
